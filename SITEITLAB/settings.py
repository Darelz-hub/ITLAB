"""
Django settings for SITEITLAB project.
...
ROOT_URLCONF = 'SITEITLAB.urls'

TEMPLATES = [
    {
        'BACKEND': "django.template.backends.django.DjangoTemplates",
        'DIRS': [
            BASE_DIR / "SITEITLAB/templates/"
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
ASGI_APPLICATION = "SITEITLAB.asgi.application"
# Database
...
# Настройка папки media для хранение видео, изображения, документов
